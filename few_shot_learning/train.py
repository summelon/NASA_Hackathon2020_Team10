...
if __name__=='__main__':
  ...
  base_datamgr            = SetDataManager(image_size, n_query = n_query,  **train_few_shot_params, night=params.night)
  base_loader             = base_datamgr.get_data_loader( base_file , aug = params.train_aug )
  test_few_shot_params     = dict(n_way = params.test_n_way, n_support = params.n_shot)
  val_datamgr             = SetDataManager(image_size, n_query = n_query, **test_few_shot_params, night=params.night)
